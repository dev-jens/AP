...
const char* WIFI_SSID = "Car1"; // Fill wifi SSID between quotes
const char* WIFI_PASS = "auto1234"; // Fill wifi pass between quotes
...
void driveMotors(int leftMotorDirection, int leftMotorSpeed, int rightMotorDirection, int rightMotorSpeed) {
  ...
  switch(leftMotorDirection){
    case MOTOR_BACKWARDS: //enumwaarde
      // stuurt leftmotorspeed naar de (1A) input op de hbrug. Dit zorgt er voor dat de auto achteruit kan rijden.
      digitalWrite(MOTOR_PINS[0], leftMotorSpeed);
      
      //lcd
      // cursur position bepalen(waar tekst start) en tekst printen op de lcd
      lcd.setCursor(0, 0);
      lcd.print("Wagon goes baack");
      
      break;
    case MOTOR_STOP:
      // stuurt 0 naar beide inputs waardoor de motor stopt
      ...
      // cursur position bepalen(waar tekst start) en tekst printen op de lcd
      lcd.setCursor(0, 0);
      lcd.print("Wagon stopt!");
      
      break;
    case MOTOR_FORWARD: 
      //stuurt rightMotorSpeed naar de (1B) input op de hbrug. Dit zorgt er voor dat de auto vooruit kan rijden.
  ...
  switch(rightMotorDirection){
    case MOTOR_BACKWARDS: 
      //stuurt leftmotorspeed naar de (2A) input op de hbrug. Dit zorgt er voor dat de auto achteruit kan rijden.
      ...
      break;
    case MOTOR_STOP:
      digitalWrite(MOTOR_CHANNELS[2], LOW);
      ...
      break;
    case MOTOR_FORWARD:
       // stuurt leftmotorspeed naar de (2B) input op de hbrug. Dit zorgt er voor dat de auto voorruit kan rijden.
      digitalWrite(MOTOR_CHANNELS[2], HIGH );
...
void barrierControl(int  ID, bool setBarrier) {
}
