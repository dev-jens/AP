...
namespace Oefening1
{
    public partial class Form1 : Form
    {
        ...
        public void CreateDataSet()
        {
            ...
            //add collum CostumerName
            ds.Tables["tblInvoices"].Columns.Add("CustumerName", typeof(String));
            ds.Tables["tblInvoices"].Columns["CustumerName"].AllowDBNull = false;
            ds.Tables["tblInvoices"].Columns["CustumerName"].MaxLength = 30;
            ...
            ds.Tables["tblInvoiceDetails"].Columns.Add("InvoiceID", typeof(Int32));
